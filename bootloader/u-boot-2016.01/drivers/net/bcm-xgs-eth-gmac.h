...
#ifndef _BCM_XGS_ETH_GMAC_H_
#define _BCM_XGS_ETH_GMAC_H_

#define BCM_XGS_ETH_MAC_NAME	"gmac"
...
#define GMAC0_SERDESCONTROL     (GMAC0_REG_BASE + 0x1a8)
#define GMAC0_SERDESSTATUS0     (GMAC0_REG_BASE + 0x1ac)
#define GMAC0_SERDESSTATUS1     (GMAC0_REG_BASE + 0x1b0)
...
#define GMAC_REG_BASE(idx)			(volatile uint32_t*)(gmac_regs[idx])
#define GMAC_DEV_CTRL_ADDR(idx)	    GMAC_REG_BASE(idx)
#define GMAC_INT_STATUS_ADDR(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x020)
#define GMAC_INTR_RECV_LAZY_ADDR(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x100)
#define GMAC_PHY_CTRL_ADDR(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x188)
#define GMAC_SERDESCONTROL(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x1a8)
#define GMAC_SERDESSTATUS0(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x1ac)
#define GMAC_SERDESSTATUS1(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x1b0)

#define GMAC_DMA_TX_CTRL_ADDR(idx)		(volatile uint32_t*)(gmac_regs[idx] + 0x200)
#define GMAC_DMA_TX_PTR_ADDR(idx)		(volatile uint32_t*)(gmac_regs[idx] + 0x204)
#define GMAC_DMA_TX_ADDR_LOW_ADDR(idx) 	(volatile uint32_t*)(gmac_regs[idx] + 0x208)
#define GMAC_DMA_TX_ADDR_HIGH_ADDR(idx) (volatile uint32_t*)(gmac_regs[idx] + 0x20c)
#define GMAC_DMA_TX_STATUS0_ADDR(idx) 	(volatile uint32_t*)(gmac_regs[idx] + 0x210)
#define GMAC_DMA_TX_STATUS1_ADDR(idx) 	(volatile uint32_t*)(gmac_regs[idx] + 0x214)

#define GMAC_DMA_RX_CTRL_ADDR(idx)		(volatile uint32_t*)(gmac_regs[idx] + 0x220)
#define GMAC_DMA_RX_PTR_ADDR(idx)		(volatile uint32_t*)(gmac_regs[idx] + 0x224)
#define GMAC_DMA_RX_ADDR_LOW_ADDR(idx) 	(volatile uint32_t*)(gmac_regs[idx] + 0x228)
#define GMAC_DMA_RX_ADDR_HIGH_ADDR(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x22c)
#define GMAC_DMA_RX_STATUS0_ADDR(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x230)
#define GMAC_DMA_RX_STATUS1_ADDR(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x234)

#define UNIMAC_CMD_CFG_ADDR(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x808)
#define UNIMAC_MAC_MSB_ADDR(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x80c)
#define UNIMAC_MAC_LSB_ADDR(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x810)
#define UNIMAC_FRM_LENGTH_ADDR(idx)	(volatile uint32_t*)(gmac_regs[idx] + 0x814)

#define GMAC_IRL_FRAMECOUNT_SHIFT	24
...
#define CHIPID		(reg32_read((volatile uint32_t*)CHIPA_CHIP_ID_ADDR) & 0xFFFF)
#define CHIPREV		((reg32_read((volatile uint32_t*)CHIPA_CHIP_ID_ADDR) >> 16) & 0xF)
#define CHIPSKU		((reg32_read((volatile uint32_t*)CHIPA_CHIP_ID_ADDR) >> 20) & 0xF)
