...
# enable combining SPL/u-boot rules for brcm iproc
ifneq ($(CONFIG_IPROC),)
ifeq ($(CONFIG_SPL),y)
ALL-y += u-boot-iproc.bin
endif
endif
...
ifneq ($(CONFIG_IPROC),)
OBJCOPYFLAGS_u-boot-spl-pad.bin = -I binary -O binary \
					--pad-to=$(CONFIG_SPL_MAX_FOOTPRINT) \
					--gap-fill=0xff

u-boot-spl-pad.bin: spl/u-boot-spl.bin FORCE
	$(call if_changed,objcopy)

u-boot-iproc.bin: u-boot-spl-pad.bin u-boot.img FORCE
	$(call if_changed,cat)
endif
