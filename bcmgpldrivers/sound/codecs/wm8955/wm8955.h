...
#define WM8955_CLKOUTDIV2                       (1<<8)  /* CLKOUTDIV2 */
#define WM8955_SAMPLE_RATE_8KHZ				(0x2 << 1)
#define WM8955_SAMPLE_RATE_12KHZ			(0x8 << 1)
#define WM8955_SAMPLE_RATE_16KHZ			(0xA << 1)
#define WM8955_SAMPLE_RATE_24KHZ		   (0x1C << 1)
#define WM8955_SAMPLE_RATE_32KHZ			(0xC << 1)
#define WM8955_SAMPLE_RATE_48KHZ			(0x0 << 1)
#define WM8955_SAMPLE_RATE_96KHZ			(0xE << 1)
...
extern int cca_spi_write_codec(uint8_t *buf, int len);
extern int cca_spi_freq_set(int speed_hz);
extern int cca_spi_init_codec(void);
