...
#define AMAC_IDM0_IO_CONTROL_DIRECT_OFFSET 0x10408
#if defined (CONFIG_MACH_HX4) || defined (CONFIG_MACH_KT2)
#define AMAC_IDM1_IO_CONTROL_DIRECT_OFFSET 0x11408
#elif defined (CONFIG_MACH_SB2)
#define AMAC_IDM1_IO_CONTROL_DIRECT_OFFSET 0x1f408
#endif
...
chipattach(etc_info_t *etc, void *osh, void *regsva)
{
	...
	if (etc->unit == 0) {
		/* Get register base address */
		amacidmaddr = get_iproc_idm_base(0) + AMAC_IDM0_IO_CONTROL_DIRECT_OFFSET;
		...
		/* Get register base address */
		amacidmaddr = get_iproc_idm_base(0) + AMAC_IDM1_IO_CONTROL_DIRECT_OFFSET;
		tmp = ioread32(amacidmaddr);
