...
LINUX_VERSION_PROBED =  $(shell cat $(LINUX_DIR)/include/config/kernel.release 2> /dev/null)
...
define LINUX_INSTALL_TARGET_CMDS
	...
	$(LINUX_INSTALL_HOST_TOOLS)
        # set a hard link for kernel modules
	rm -f $(TARGET_DIR)/lib/modules/linux
	ln -s $(LINUX_VERSION_PROBED) $(TARGET_DIR)/lib/modules/linux
endef
